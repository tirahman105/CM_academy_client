...
const DashboradCourses = () => {
    ...
    const [selectedCategory, setSelectedCategory] = useState('All Courses'); // Default to show all courses
        ...
        <div>
            ...
            <div className='flex justify-start gap-4 text-lg items-center mb-2 mt-4 font-bold font-Jost'>
                <h1
                    ...
                    className={`cursor-pointer ${selectedCategory === 'All Courses' ? 'border border-gray-600 px-2 py-1 rounded-lg bg-gray-700 text-white duration-300 transition-all' : 'text-black'}`}
                >
                    All Approved
                </h1>
                <h1
                    onClick={() => setSelectedCategory('Newest')}
                    className={`cursor-pointer ${selectedCategory === 'Newest' ? 'border border-gray-600 px-2 py-1 rounded-lg bg-gray-700 text-white duration-300 transition-all' : 'text-black'}`}
                >
                    Pending
                </h1>
                <h1
                    onClick={() => setSelectedCategory('Top Rated')}
                    className={`cursor-pointer ${selectedCategory === 'Top Rated' ? 'border border-gray-600 px-2 py-1 rounded-lg bg-gray-700 text-white duration-300 transition-all' : 'text-black'}`}
                >
                    Most Enrolled
                </h1>
            </div>
