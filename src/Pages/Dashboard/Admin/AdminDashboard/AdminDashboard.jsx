...
// import { GrChapterAdd, GrFormNext, GrFormPrevious } from 'react-icons/gr';
          ...
          <div className="">
            <div className="grid grid-cols-2 gap-4 mt-6 laptop:-mt-28">
              <div className="bg-gray-100 p-4 text-center rounded-lg flex items-center justify-center gap-4">
                ...
                <p className="text-lg font-normal">Approved Courses</p>
              </div>

              <div className="bg-gray-100 p-4 text-center rounded-lg flex items-center justify-center gap-4">
                <p className="text-6xl font-extrabold">{totalDeniedCourses}</p>
                <p className="text-lg font-normal">Denied Courses</p>
              </div>
            </div>
          </div>
        </div>
