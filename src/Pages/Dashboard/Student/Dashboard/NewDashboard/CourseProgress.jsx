          ...
          <div className="bg-gray-100 p-2 rounded-md ">
            ...
            <div className="flex justify-start laptop:gap-2 desktop:gap-0 items-center desktop:space-x-10 tablet:space-x-10 laptop:space-x-0 bg-gray-100 p-2 rounded-md">
              ...
              <div className=" ml-2 min-w-0 laptop:min-w-[20px]">
                <p className="text-gray-900 mobile:text-[14px] laptop:text-[14px]  font-bold desktop:text-lg truncate mobile:hidden">
                  {courses[currentCourseIndex]?.course.title}
                </p>
              ...
              <div className="mobile:ml-4 flex items-center gap-2">
                <svg
                  ...
                  className="w-12 h-12 mobile:w-8 mobile:h-8"
                  viewBox="0 0 100 100"
                >
                  <circle
              ...
              <div className="flex justify-between gap-4 items-center text-4xl ml-6 tablet:bg-white p-3 rounded-xl">
                <button onClick={handlePrevClick}>
                  <BsArrowLeftCircle className="hover:scale-105 duration-300 mobile:text-2xl laptop:text-xl desktop:text-4xl" />
                </button>
                <button onClick={handleNextClick}>
                  <BsArrowRightCircleFill className="hover:scale-105 duration-300 laptop:text-xl mobile:text-2xl  desktop:text-4xl" />
                </button>
              </div>
            </div>
          </div>
