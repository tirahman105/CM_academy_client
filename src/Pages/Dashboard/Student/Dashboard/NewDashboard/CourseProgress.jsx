            ...
            <div className="rounded-lg flex items-center">
                <div className="card-container w-full">
                    <div className='flex justify-start items-center space-x-10 bg-gray-100 p-2 rounded-md'>
                        <img
                            src={courses[currentCourseIndex]?.courseThumbnail}
                        ...
                        <div className="flex-1 min-w-0">
                            ...
                            <p className="text-sm text-gray-600">
                                by {courses[currentCourseIndex]?.instructor}
                            </p>
                        </div>
                        ...
                        <div className='flex items-center gap-2'>
                            ...
                            >
                                <circle
                                    ...
                                    strokeDashoffset={251.2 - (251.2 * courses[currentCourseIndex]?.progress) / 100}
                                ...
                                >
                                    {courses[currentCourseIndex]?.progress}%
                                </text>
                            </svg>
                        </div>

                        <div className="flex items-center space-x-2">
                            <button className="ml-auto border-2 bg-black hover:bg-white hover:text-black text-white text-base px-4 py-2 rounded-lg transition duration-300">
                                Continue
                            </button>
                        </div>
