...
const Tiles = ({ course, selectedCategory }) => {
  ...
  return (
    <>
  <div key={course?.course?._id || course?._id} className="max-w-full bg-gray-100 rounded-lg mobile:px-1 mobile:py-2 tablet:p-4 flex mobile:gap-4 items-center desktop:space-x-4 tablet:space-x-6 laptop:space-x-2 mt-2">
  <img
  ...
  {selectedCategory == "Most Popular" ? (
    <button
      ...
      onClick={() => handleDetailsClick(course?.course || course)}
    >
      Details
