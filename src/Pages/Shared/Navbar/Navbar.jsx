...
//   return (
//     <div className="fixed py-3 left-0 right-0  px-4 mx-auto   bg-white shadow-sm bg-opacity-70 backdrop-blur-lg">
...
//               <span><BiSolidChevronDown></BiSolidChevronDown></span>
//             </Link>
//             {isAboutDropdownOpen && (
//               <ul
//                 onMouseEnter={handleMouseEnter}
...
//               <Link to="/login"
//                 className="text-gray-700 font-Raleway border-2 font-bold  rounded-xl px-4 css-selector   hover:border-[#1bbf7246] duration-500 
//               hover:bg-[#1bbf7249] hover:text-gray-600 shadow-md my-4">
//                 Login
//               </Link>
//             )}
